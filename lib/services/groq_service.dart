...
Analyze the user brain dump text and extract structured information.
...
Keep total response under 300 words.''';
  ...
  static Future<String> getDailyTip() async {
    const systemPrompt =
        'You are a study coach. Give one short, practical study tip. Maximum 2 sentences. No emojis.';
    const userMessage =
        'Give me one practical study or productivity tip for today.';
    return await _sendRequest(
      systemPrompt: systemPrompt,
      userMessage: userMessage,
      maxTokens: 100,
