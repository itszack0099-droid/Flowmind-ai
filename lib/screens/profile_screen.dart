...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final email = _profile?['email'] ?? SupabaseService.currentUser?.email ?? '';
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(CupertinoIcons.pencil, color: isDark ? AppColors.textLight : AppColors.textDark, size: 18),
                    ),
                  ],
                ),
              ),
                  ...
                  child: _isLoading
                      ...
                      : Column(
                          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(color: AppColors.mint.withOpacity(0.3), blurRadius: 20, spreadRadius: 2),
                                    ],
                                  ),
                            ...
                            Row(
                              children: [
                                _ProfileStat(value: '$xp', label: 'XP Points'),
                                Container(width: 1, height: 30, color: Colors.white.withOpacity(0.08), margin: const EdgeInsets.symmetric(horizontal: 16)),
                                _ProfileStat(value: '$streak', label: 'Day Streak'),
                                Container(width: 1, height: 30, color: Colors.white.withOpacity(0.08), margin: const EdgeInsets.symmetric(horizontal: 16)),
                                _ProfileStat(value: '$level', label: 'Level'),
                              ],
                            ),
                          ],
                        ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text('Upgrade to Pro', style: GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w700, color: isDark ? AppColors.textLight : AppColors.textDark)),
                            Text('Unlock all features — Rs.149/month', style: GoogleFonts.plusJakartaSans(fontSize: 12, color: isDark ? AppColors.mutedDark : AppColors.mutedLight)),
                          ],
                        ),
                      ),
                      Container(
                        ...
                        child: Text('Upgrade', style: GoogleFonts.plusJakartaSans(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white)),
                      ),
                    ],
                  ),
                ),
...
class _ToggleSetting extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Container(width: 36, height: 36, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: color.withOpacity(0.12)), child: Icon(icon, color: color, size: 18)),
          const SizedBox(width: 14),
          Expanded(child: Text(label, style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w500, color: isDark ? AppColors.textLight : AppColors.textDark))),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Container(width: 36, height: 36, decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: color.withOpacity(0.12)), child: Icon(icon, color: color, size: 18)),
            const SizedBox(width: 14),
            Expanded(child: Text(label, style: GoogleFonts.plusJakartaSans(fontSize: 14, fontWeight: FontWeight.w500, color: isDestructive ? AppColors.orangeRed : (isDark ? AppColors.textLight : AppColors.textDark)))),
            if (value != null) ...[Text(value!, style: GoogleFonts.plusJakartaSans(fontSize: 13, color: isDark ? AppColors.mutedDark : AppColors.mutedLight)), const SizedBox(width: 6)],
            if (!isDestructive) Icon(CupertinoIcons.chevron_right, color: isDark ? AppColors.mutedDark : AppColors.mutedLight, size: 16),
          ],
        ),
      ),
    );
