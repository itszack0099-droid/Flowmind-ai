            ...
            child: Column(
              ...
              children: [
                ...
                FadeInDown(
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 36, height: 36, child: Image.asset('assets/images/logo.png')),
                ...
                FadeInDown(
                  ...
                  child: Text('Sign Up',
                    style: GoogleFonts.plusJakartaSans(fontSize: 38, fontWeight: FontWeight.w800,
                ...
                FadeInDown(
                  ...
                  child: Text('CREATE YOUR ACCOUNT & START YOUR JOURNEY',
                    style: GoogleFonts.plusJakartaSans(fontSize: 11, fontWeight: FontWeight.w500,
                      color: isDark ? AppColors.mutedDark : AppColors.mutedLight, letterSpacing: 1.5)),
                ),
                ...
                FadeInUp(
                  ...
                  child: GlassCard(
                    ...
                    child: Column(
                      children: [
                        GlassTextField(hint: 'Full Name', suffixIcon: Icons.person_outline_rounded,
                          controller: _nameController, keyboardType: TextInputType.name),
                        const SizedBox(height: 14),
                        GlassTextField(hint: 'Email Address', suffixIcon: Icons.email_outlined,
                          controller: _emailController, keyboardType: TextInputType.emailAddress),
                        const SizedBox(height: 14),
                        GlassTextField(
                          hint: 'Password',
                          suffixIcon: _obscurePassword ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                          obscureText: _obscurePassword, controller: _passwordController,
                          onSuffixTap: () => setState(() => _obscurePassword = !_obscurePassword)),
                        const SizedBox(height: 14),
                        GlassTextField(
                          hint: 'Confirm Password',
                          suffixIcon: _obscureConfirm ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                          obscureText: _obscureConfirm, controller: _confirmPasswordController,
                              ...
                              AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  gradient: _agreeToTerms
                                      ...
                                      : null,
                                  border: _agreeToTerms ? null : Border.all(color: AppColors.mutedDark, width: 1.5)),
